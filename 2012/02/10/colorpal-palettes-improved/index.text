...
[<img src="{attach}colorpal_logo.png" alt="ColorPal logo" title=""
/>](/projects/colorpal)
...
mean]({attach}median-mean-comparison.png)
...
![16 million colors versus 16 colors]({attach}median-cut-example.png)
...
![mean, median, and mode graphed]({attach}mean_median_mode.png)
...
![Forest red   pixel distribution]({attach}forest_r.png)
![Forest green pixel distribution]({attach}forest_g.png)
![Forest blue  pixel distribution]({attach}forest_b.png)

For comparison, here are the distributions for a shot of NYC.

![City   red   pixel distribution]({attach}city_r.png)
![City   green pixel distribution]({attach}city_g.png)
![City   blue  pixel distribution]({attach}city_b.png)
